...
\
	...
	file://php-8.5.0-includedir.patch \
	file://php-8.5.0-embed.patch \
	file://php-8.4.0-libdb.patch \
	file://php-8.5.0-parser.patch \
	file://php-8.5.0-systzdata-v24.patch \
	file://php-8.4.0-phpize.patch \
	file://php-8.5.0-ldap_r.patch \
	file://php-8.0.7-argon2.patch \
	file://php-8.4.0-phpinfo.patch \
	file://php-7.4.0-datetests.patch \
"

SRC_URI[sha256sum] = "cb75a9b00a2806f7390dd64858ef42a47b443b3475769c8af6af33a18b1381f1"
